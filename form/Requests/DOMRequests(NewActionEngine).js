...
var SignUpRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["inside sign up request"],
  },
  {
...
var loginRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["inside login request"],
  },
  {
    response: "GetUsername",
    objectModel: "document",
...
var importFromSheetRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["processing import from request"],
  },
  {
...
var getActionStoriesRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["processing actionstories request"],
  },
  {
    response: "GetSpreadsheetId",
    objectModel: "document",
  ...
  },
  {
    ...
    objectModel: "httpService",
    method: "urlBuilder",
    arguments: ["$scriptURL", "$l.param"],
  },
  {
    response: "SetParametersJson",
    declare: {
      paramJSON: {
        SpreadsheetId: "$l.GetSpreadsheetId.value",
        NamedRange: "$l.GetNamedRange.value",
  ...
  },
  {
    objectModel: "console",
    method: "log",
    arguments: "ActionStoriesResponse",
  },
  {
    response: "RequestNotSent",
...
var getGoogleDriveFolderRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["processing get google drive folder request"],
  },
  {
    response: "EditorElement",
    objectModel: "document",
  ...
  },
  {
    response: "SetParameters",
    declare: {
      param: [["SearchFolderName", "$l.GetfolderName.value"]],
    },
  },
...
var recentFilesRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["recent files request"],
  },
  {
    response: "EditorElement",
    objectModel: "document",
...
var AddACollectionRequest = [
  {
    ...
    objectModel: "window",
    method: "alert",
    arguments: ["processing add a collection request"],
  },
  {
...
var publishAppsScriptProject = [
  ...
  },
  {
    ...
    method: "fetchRequest",
    arguments: [
      "https://www.googleapis.com/drive/v2/files/1qTU9AIyukBXFNrgITRlPoDQEjhkWz_E_bUm5uqmLu4g/copy",
      "$l.RequestToCopySheets",
    ],
  },
  {
  ...
  },
  {
    ...
    arguments: [
      "https://script.googleapis.com/v1/projects/",
      "$l.ResponseToCreateProject.scriptId",
      "/content",
    ],
    exit: true,
  },
  ...
  },
  {
    ...
    arguments: [
      ...
      "$l.ResponseToDeployProject.deploymentId",
      "/exec",
    ],
    exit: true,
  },
